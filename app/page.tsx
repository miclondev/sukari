  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-semibold mb-2">Immersive guided tours, all around the globe</h1>
        <p className="text-muted-foreground mb-8">Follow with a friend, the whole family, or solo. However—and whenever—you want to go, our expert-planned group travel experiences make it easy to see the world.</p>

        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <Card className="relative overflow-hidden h-[400px] group">
            <img
              src="https://images.unsplash.com/photo-1508930175694-38f4e3213b2e?auto=format&fit=crop&q=80&w=1200"
              alt="Greece Tours"
              className="absolute inset-0 w-full h-full object-cover transition-transform group-hover:scale-105"
            />
            <div className="absolute inset-0 bg-black/40 p-8 flex flex-col justify-end text-white">
              <h2 className="text-3xl font-bold mb-4">Choose from 200+ group tours and 80+ countries</h2>
              <Button className="w-fit bg-white text-ef-dark hover:bg-white/90">Shop all destinations</Button>
            </div>
          </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          <Card className="bg-ef-teal text-white p-6">
            ...
            <p className="text-white/80 mb-4">You dream it. We&apos;ll take care of every last detail.</p>
            <Button variant="outline" className="text-white border-white hover:bg-white hover:text-ef-teal">
              Find out how
            </Button>
          </Card>
          ...
          {[
            ...
            },
            {
              ...
              description: "While you're deciding what to take, we'll be busy planning every detail"
            }
          ].map((step, index) => (
        ...
        <div className="mb-12">
          ...
          <p className="text-muted-foreground mb-8">Choose from more than 200 one-of-a-kind group travel experiences, carefully designed by experts, led by locals, and made for you.</p>
              ...
              <Card key={tour.id} className="overflow-hidden border-ef-light group">
                <Link href={`/tours/${tour.slug}`}>
                  ...
                  <CardContent className="p-4">
                    <h3 className="font-semibold mb-2 group-hover:text-ef-orange transition-colors">{tour.title}</h3>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm line-through text-muted-foreground">${tour.originalPrice}</p>
                      </div>
                      <Button variant="outline" className="text-sm border-ef-orange text-ef-orange hover:bg-ef-orange hover:text-white">
                        View tour
                      </Button>
                    </div>
                  </CardContent>
